...
const About = () => {
  return (
      ...
      <div 
      id="main"
      className='w-full h-auto flex justify-center mt-10 mb-10'>
        
        <div
        id='content'
        className='w-[90%] h-auto border-2 border-black flex justify-center items-center flex-col p-10 shadow-2xl'>

          <span className='font-serif font-bold text-5xl mb-6 sm:text-6xl text-center'>About Us</span>
          ...
          <span className='font-serif font-bold text-3xl sm:text-4xl mb-4'>Our Mission</span>
          ...
          <span className='font-serif font-bold text-3xl sm:text-4xl mb-4'>What We Offer?</span>
          ...
          <span className='font-serif font-bold text-3xl sm:text-4xl text-center mb-4'>What Choose Us?</span>
          ...
          <span className='font-serif font-bold text-3xl sm:text-4xl mb-4'>Our Vision</span>
          ...
          <span className='font-serif font-bold text-3xl sm:text-4xl mb-4'>Join Us Today!</span>
